...
I was bored at work so I wrote these two scripts. First I wrote the guesser, then the solver.

NUMBER_GUESS
Number guess takes a max number and creates a random number between 0 and your number.
